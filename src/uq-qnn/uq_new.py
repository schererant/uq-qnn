...
TRAINING_MEMORY_DEPTH = 3
TRAINING_STEPS = 10
TRAINING_LEARNING_RATE = 0.1
TRAINING_CUTOFF_DIM = 4

PREDICT_MEMORY_DEPTH = 3
PREDICT_STOCHASTIC = True
PREDICT_SAMPLES = 3
PREDICT_VARIANCE = 0.1
PREDICT_CUTOFF_DIM = 4
...
def main():
    ...
    res_mem, phase1, phase3, memristor_weight = train_memristor(X_train, 
                                                                y_train, 
                                                                memory_depth=TRAINING_MEMORY_DEPTH, 
    ...
    predictions, targets, predictive_uncertainty = predict_memristor(X_test, 
                                                                     y_test, 
                                                                     memory_depth=PREDICT_MEMORY_DEPTH, 
                                                                     phase1=phase1, 
                                                                     phase3=phase3, 
